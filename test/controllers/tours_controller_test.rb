...
class ToursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour" do
    assert_difference("Tour.count") do
      post tours_url, params: { tour: {eveniment_id: @tour.eveniment_id, data_ora: @tour.data_ora, detalii: @tour.detalii } }
    end
  ...
  test "should update tour" do
    patch tour_url(@tour), params: { tour: { eveniment_id: @tour.eveniment_id, data_ora: @tour.data_ora, detalii: @tour.detalii } }
